...
Date: 2026-08-18 · Status: Accepted · Amended by: [ADR-0038](0038-github-releases-only-for-version-one.md) (update channel), [ADR-0040](0040-egress-requirement-and-verification.md) (verification requirement), [ADR-0042](0042-enforce-process-egress-observation.md) (executable evidence) · Source: historical pre-release architecture
